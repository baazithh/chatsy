...
export default function NavBar() {
  ...
  return (
    <nav className="fixed top-6 left-1/2 -translate-x-1/2 w-[95%] max-w-6xl z-50">
      <div className="holographic-panel px-8 py-4 flex justify-between items-center transition-all bg-black/40 backdrop-blur-xl border-cyan-500/20 shadow-[0_0_30px_rgba(0,0,0,0.5)]">
            ...
            return (
              ...
              >
                ...
                {isActive && (
                  <motion.div 
                    layoutId="activeNav"
                    className="absolute -bottom-1 left-0 right-0 h-[2px] bg-cyan-500 shadow-[0_0_10px_rgba(6,182,212,0.8)]"
                  />
                )}
              </Link>
            );
