...
export default function Home() {
  return (
    <main className="min-h-screen relative overflow-hidden flex flex-col items-center justify-center p-6 perspective-container">
      ...
      <div className="absolute top-1/4 left-1/4 w-[400px] h-[400px] border border-cyan-500/20 rounded-full blur-[2px] -z-10 animate-[spin_20s_linear_infinite] [transform:rotateX(60deg)]" />
      <div className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] border border-magenta-500/20 rounded-full blur-[2px] -z-10 animate-[spin_30s_linear_reverse_infinite] [transform:rotateX(50deg)]" />
